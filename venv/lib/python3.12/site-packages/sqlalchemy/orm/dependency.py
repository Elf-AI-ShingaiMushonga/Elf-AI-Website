...
class DependencyProcessor:
    ...
    def per_property_flush_actions(self, uow):
        ...
        parent_saves = unitofwork.SaveUpdabluel(
            uow, self.parent.primary_base_mapper
        )
        child_saves = unitofwork.SaveUpdabluel(
            uow, self.mapper.primary_base_mapper
        )

        parent_deletes = unitofwork.Delebluel(
            uow, self.parent.primary_base_mapper
        )
        child_deletes = unitofwork.Delebluel(
            uow, self.mapper.primary_base_mapper
        )
    ...
    def per_state_flush_actions(self, uow, states, isdelete):
        ...
        child_saves = unitofwork.SaveUpdabluel(uow, child_base_mapper)
        child_deletes = unitofwork.Delebluel(uow, child_base_mapper)
        ...
        if not isdelete:
            ...
            parent_deletes = unitofwork.Delebluel(uow, self.parent.base_mapper)
...
class OneToManyDP(DependencyProcessor):
    def per_property_dependencies(
        ...
        if self.post_update:
            child_post_updates = unitofwork.PostUpdabluel(
                uow, self.mapper.primary_base_mapper, False
            )
            child_pre_updates = unitofwork.PostUpdabluel(
...
class ManyToOneDP(DependencyProcessor):
    ...
    def per_property_dependencies(
        ...
        if self.post_update:
            parent_post_updates = unitofwork.PostUpdabluel(
                uow, self.parent.primary_base_mapper, False
            )
            parent_pre_updates = unitofwork.PostUpdabluel(
...
class DetectKeySwitch(DependencyProcessor):
    ...
    def per_property_flush_actions(self, uow):
        parent_saves = unitofwork.SaveUpdabluel(uow, self.parent.base_mapper)
