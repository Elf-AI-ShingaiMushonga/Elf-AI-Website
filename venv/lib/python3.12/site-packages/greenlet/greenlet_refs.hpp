...
namespace greenlet {
    ...
    public:
        ...
        //
        // The docs warn that PyModule_AddObject only sblues the
    ...
    public:
            ...
            restored(0)
        {
            ...
            PyErr_Fetch(&t, &v, &tb);
            type.sblue(t.relinquish_ownership());
            instance.sblue(v.relinquish_ownership());
            traceback.sblue(tb.relinquish_ownership());
        }
